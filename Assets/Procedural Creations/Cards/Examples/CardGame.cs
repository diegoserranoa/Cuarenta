...
public class CardGame : MonoBehaviour
{
	...
	void HitDealer()
	{
		...
		if (c1 != null)
		{
			...
			newCard.TryBuild();
			MeshCollider meshCollider = newObj.AddComponent(typeof(MeshCollider)) as MeshCollider;
			Mesh mesh = newObj.GetComponent<Card>().GetComponent<MeshFilter>().mesh;
			...
			newCard.SetFlyTarget(deckPos,new Vector3(x,5,z),FlyTime, true);
		}
	}
	void HitPlayer()
	{
		...
		if (c1 != null)
		{
			...
			float y = -5-m_player.Count*0.15f;
			...
			newCard.SetFlyTarget(deckPos,new Vector3(x,y,z),FlyTime, false);
		}
	}
